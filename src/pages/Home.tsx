    ...
    <div className="pt-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      >
        ...
        <div className="grid grid-cols-4 gap-3">
          {categories.length > 0 ? (
            ...
            [
              { name: '效率工具', Icon: Zap },
              { name: '生活助手', Icon: HomeIcon },
              { name: '健康运动', Icon: Heart },
              { name: '学习教育', Icon: Book },
              { name: '娱乐休闲', Icon: Gamepad2 },
              { name: '金融理财', Icon: DollarSign },
              { name: '开发工具', Icon: Code },
              ...
              >
                ...
                >
                  <div className="w-10 h-10 rounded-[12px] bg-gradient-to-br from-[#8B5CF6]/20 to-[#6D28D9]/20 flex items-center justify-center mb-2 group-hover:scale-110 transition-transform">
                    <cat.Icon className="w-5 h-5 text-[#8B5CF6]" />
                  </div>
                  <span className="text-sm text-white/80 text-center truncate w-full">{cat.name}</span>
                </Link>
              </motion.div>
            ))
          )}
      ...
      >
        ...
        {recommendedTools.length > 0 ? (
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/[0.08] rounded-[16px] p-8 text-center">
            <Heart className="w-12 h-12 text-white/20 mx-auto mb-3" />
            <p className="text-white/50">暂无推荐内容</p>
            <p className="text-white/30 text-sm mt-1">浏览更多工具后我们会为您推荐</p>
          </div>
        )}
      </motion.section>
      ...
      >
        ...
        {hotTools.length > 0 ? (
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/[0.08] rounded-[16px] p-8 text-center">
            ...
            <p className="text-white/50">暂无热门工具</p>
            <p className="text-white/30 text-sm mt-1">成为第一个上榜的开发者吧</p>
          </div>
        )}
      </motion.section>
      ...
      >
        ...
        {featuredTools.length > 0 ? (
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/[0.08] rounded-[16px] p-8 text-center">
            ...
            <p className="text-white/50">暂无精品推荐</p>
            <p className="text-white/30 text-sm mt-1">精品工具即将上架，敬请期待</p>
          </div>
        )}
      </motion.section>
      ...
      >
        ...
        {newTools.length > 0 ? (
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/[0.08] rounded-[16px] p-8 text-center">
            ...
            <p className="text-white/50">今日暂无新上架</p>
            <p className="text-white/30 text-sm mt-1">新工具将第一时间在这里展示</p>
          </div>
        )}
      </motion.section>
    </div>
